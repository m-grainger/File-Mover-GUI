...
class Mover:
    ...
    def __init__(self, master):
        ...
        master.geometry('600x225') 
        master.title('File Mover')
        master.resizable(False,False)
       
        ttk.Label(self.frame_header, text = 'Welcome to the File Moving Program!').grid(row = 0, column = 0, rowspan = 3, pady = 20)
        ...
        ttk.Label(self.frame_content, textvariable = self.destName).grid(row = 4, column = 0, rowspan = 3, pady = 5, padx = 5, sticky = W)
